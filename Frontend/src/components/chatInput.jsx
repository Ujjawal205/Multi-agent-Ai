...
function chatinput() {
  ...
  return (
    <div className='w-full overflow-hidden px-3 md:px-5 py-4 border-t
    border-white/[0.06] bg-[#0d0f14]'>
        ...
        rounded-2xl px-4 pt-3.5 pb-3'>
            ...
            <div className=' flex items-center justify-between'>
               ...
               className={`flex items-center justify-center w-8 h-8 rounded-lg border-none transition-all cursor-pointer duration-150
